        ...
        <>
          ...
          >
            ...
            <div
                ...
                aria-label="Sidebar"
            >
                <div className="h-full px-3 py-4 overflow-y-auto bg-blue1">
                <a href="*" className="flex items-center ps-2.5 mb-5">
                    <span className="self-center text-2xl font-semibold text-white whitespace-nowrap">GStore</span>
                    <button
                        onClick={toggleSidebar}
                        aria-controls="logo-sidebar"
                        type="button"
                ...
                {menuItems.map((item) => (
                  <li key={item.id}>
                    ...
                    >
                      ...
                      <span className="ms-3 group-hover:text-blue1">{item.label}</span>
                    </a>
                  </li>
                ))}
              </ul>
